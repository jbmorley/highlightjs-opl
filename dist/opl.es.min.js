/*! `opl` grammar compiled for Highlight.js 11.11.1 */
var hljsGrammar=(()=>{"use strict";return e=>({name:"OPL",case_insensitive:!0,
keywords:{$pattern:/[a-z$&%:]+/,
...
},contains:[{className:"string",begin:'"',end:'"'},e.COMMENT("REM","\n",{
contains:[{className:"doc",begin:"@\\w+"}]})]})})();export default hljsGrammar;